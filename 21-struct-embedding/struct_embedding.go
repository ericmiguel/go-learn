...
go directive introduced in Go version 1.16+ to embed files and folders into
...
func main() {
	...
	// a container. Here we invoke a method that was embedded from base directly on co.
	fmt.Println("describe:", co.describe())

	// Embedding structs with methods may be used to bestow interface
	// implementations onto other structs. Here we see that a container
	// now implements the describer interface because it embeds base.
